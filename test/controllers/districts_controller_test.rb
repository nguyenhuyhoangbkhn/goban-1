...
class DistrictsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create district" do
    assert_difference('District.count') do
      post districts_url, params: { district: { district_kind: @district.district_kind, name: @district.name, ordinate: @district.ordinate, provincial_id: @district.provincial_id } }
    end
  ...
  test "should update district" do
    patch district_url(@district), params: { district: { district_kind: @district.district_kind, name: @district.name, ordinate: @district.ordinate, provincial_id: @district.provincial_id } }
