...
class VillagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create village" do
    assert_difference('Village.count') do
      post villages_url, params: { village: { district_id: @village.district_id, name: @village.name, ordinate: @village.ordinate, village_kind: @village.village_kind } }
    end
  ...
  test "should update village" do
    patch village_url(@village), params: { village: { district_id: @village.district_id, name: @village.name, ordinate: @village.ordinate, village_kind: @village.village_kind } }
